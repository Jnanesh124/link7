This is a [Laravel](https://t9602983-link7.org/) project bootstrapped with `composer create-project t9602983-link7/t9602983-link7 t9602983-link7-wasmer-example` (with some minor adaptations for Wasmer).
